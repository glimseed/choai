...
repository for convenience and is built on its own, with its own dependencies,
into its own directory. The GPL at the root of this repository covers the app
