import { formatAmount, formatMixed } from "~/hledger/amount"
import type { MixedAmount, Posting, Transaction } from "~/hledger/wire"
import { spanOf, type Span } from "~/journal/lines"
